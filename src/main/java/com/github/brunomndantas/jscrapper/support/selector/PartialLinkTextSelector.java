...
public class PartialLinkTextSelector extends Selector {
    ...
    public PartialLinkTextSelector(String selector) {
    ...
    protected Collection<WebElement> selectElements(WebDriver driver) throws Exception {
        return driver.findElements(By.partialLinkText(this.selector));
    }
