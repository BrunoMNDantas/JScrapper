...
public class PartialLinkTextSelectorTest {
    ...
    public void getSelectorTest() {
        String s = "";
        PartialLinkTextSelector selector = new PartialLinkTextSelector(s);
    ...
    public void selectEmptyResultTest() throws Exception {
        ...
        driver.get(htmlFile);
        PartialLinkTextSelector selector = new PartialLinkTextSelector("lin");
